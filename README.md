...
aforementioned prompt and adds the logging from the command to the new file. There's error handling for the command and logfile creation to insure that if the command and/or the 
